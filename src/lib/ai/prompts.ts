...
- ضریب بازگشت (Recovery Factor): ${stats.recoveryFactor}
  ...
  فرمت خروجی باید **یک متن Markdown کاملاً فارسی و روان** باشد که شامل دقیقاً ۵ سرتیتر زیر است (لطفاً از JSON استفاده نکنید، فقط مارک‌داون تمیز با بولت‌پوینت و متن):
  1. **📊 تحلیل کارنامه آماری و آمار‌های کلیدی گزارش**: کالبدشکافی سوددهی، فاکتور سود، وین‌ریت و R:R. آیا این لبه معاملاتی واقعی است؟
  2. **🌟 نقاط قوت و مهارت‌های عملکردی**: پیدا کردن نقاط قوت واقعی اما بدون اغراق.
  3. **⚠️ تله‌های روانشناختی و مدیریت ریسک**: بی‌رحمانه‌ترین بخش گزارش. اشتباهات مهلک در ریسک به ریوارد، افت حساب (Drawdown)، یا رفتارهای قماری را با لحن تند گوشزد کنید.
  4. **📈 بهینه‌سازی ستاپ‌های معاملاتی**: بر اساس درصد برد خرید در برابر فروش، و R:R، چه توصیه‌ای برای ورود و خروج‌ها دارید؟
  5. **⏱️ تحلیل زمان، و تایم‌فریم معاملات**: بررسی امید ریاضی و ریسک‌پذیری در طول زمان. توصیه‌های نهایی برای بقا در بازار.
`;
}
